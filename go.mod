...
require (
	...
	kubedb.dev/apimachinery v0.34.0-rc.0.0.20230614152449-95127a0fb10d
	kubestash.dev/apimachinery v0.1.1-0.20230602100035-61facde50842
...
require (
	...
	stash.appscode.dev/apimachinery v0.30.0 // indirect
)
